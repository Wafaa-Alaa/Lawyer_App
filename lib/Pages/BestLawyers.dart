...
class BestLawyers extends StatefulWidget {
  const BestLawyers({super.key});

  @override
  State<BestLawyers> createState() => _BestLawyersState();
}

class _BestLawyersState extends State<BestLawyers> {
  CollectionReference users = FirebaseFirestore.instance.collection('users');
  @override
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
        stream: users.orderBy('rateing', descending: true).snapshots(),
